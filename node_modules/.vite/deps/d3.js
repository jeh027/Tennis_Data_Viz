...
function arc_default() {
  var innerRadius = arcInnerRadius, outerRadius = arcOuterRadius, cornerRadius = constant_default11(0), padRadius = null, startAngle = arcStartAngle, endAngle = arcEndAngle, padAngle = arcPadAngle, context = null, path3 = withPath(arc);
  function arc() {
    ...
    if (!(r1 > epsilon8))
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da2, da1 = da2, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon8 && (padRadius ? +padRadius.apply(this, arguments) : sqrt3(r0 * r0 + r1 * r1)), rc = min4(abs4(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t02, t12;
      if (rp > epsilon8) {
...
function line_default2(x4, y4) {
  var defined = constant_default11(true), context = null, curve = linear_default, output = null, path3 = withPath(line);
...
function area_default5(x06, y06, y12) {
  var x12 = null, defined = constant_default11(true), context = null, curve = linear_default, output = null, path3 = withPath(area);
...
function pie_default() {
  var value = identity_default5, sortValues = descending_default, sort3 = null, startAngle = constant_default11(0), endAngle = constant_default11(tau7), padAngle = constant_default11(0);
  function pie(data) {
